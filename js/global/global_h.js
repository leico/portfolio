...
var $leico = {    //namespace $leico;
  $global : {} //namespace $leico :: $global;
};
  ...
  ((function(undefined)
    {
       ...
       * property  : 追加するオブジェクト     *
       * ==================================== */
      $ns.namespace = function(global, namespace, property, undefined)
      {
        global            = global            || {};
  ...
  ((function(undefined)
    {
       ...
       * parent : 親クラス                         *
       * ========================================= */
      $ns.inheritance = function(child, parent)
      {
  ...
  ((function(undefined)
    {
       ...
       * =============================================== */
      $ns.extend = function(parent, property)
      {
